package it.polito.mad.polijob.navigation;
 ...
 */
public class PoliJobNavigationDrawer {
    ...
    public PoliJobNavigationDrawer(String[] titles, int[] icons, DrawerLayout drawerLayout,
