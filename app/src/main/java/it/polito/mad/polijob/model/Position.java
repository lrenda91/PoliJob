...
public class Position extends ParseObject {
    ...
    public Company getParentCompany(){
        return ((Company) get(PARENT));
    }
    public void setParentCompany(ParseObject value){
        put(PARENT, value);
    }
    ...
    public ParseRelation<Student> getRelationAppliedStudents(){
        return getRelation(APPLIEDSTUS);
    }
    public void addAppliedStudents(ParseRelation relation, Student student){
        relation.add(student);
    }

    public void removeAppliedStudents(ParseRelation relation, Student student){
